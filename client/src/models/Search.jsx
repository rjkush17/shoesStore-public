        ...
        <section className="bg-white text-lg  rounded-md px-4 max-w-[500px] mobile:w-[500px] h-screen mobile:h-3/4">
          ...
          {currentQ.length == 0 && (
            <div>
              ...
              <p className="w-8/12 mx-auto text-xl">"Find Your Perfect Pair: Search Your Favorite Shoes Here"</p>
          ...
          {currentQ.length >= 1 &&
            ...
            searchDATA.length >= 1 && (
              <div className="overflow-y-scroll h-96">
                {fliteredlist.map((val, ind) => (
                  <div key={ind} className="flex mx-8 gap-4 items-center mb-4">
                    <div className="w-14">
            ...
            <div className="h-4/4 mt-12">
              ...
              <button className="button bg-red-400 text-white">Explore shop</button>
            </div>
             }
